...
import SaisirAgence from './saisir-agence/SaisirAgence';
        ...
        <div className="title-back">
            ...
            <div className="container-creation">
                ...
                <StepContainer styleFleche={{backgroundColor: "#3399FE"}} imgFleche={basFleche} containerTitle={"Ma demande"}>
                    <StepContent styleCercle={{backgroundColor: "#2EBC34"}} titleContent={"Mes piéces et Mon Selfie Check"} />
                    <StepContent styleCercle={{backgroundColor: "#2EBC34"}} titleContent={"Mes Informations"}/>
                    <StepContent styleCercle={{backgroundColor: "#3399FE"}} titleContent={"Mon Agence"}>
                        <SaisirAgence />
                    </StepContent>
