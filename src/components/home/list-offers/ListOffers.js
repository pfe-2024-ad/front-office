...
function ListOffers(){
    return(
        ...
        <div className='container'> 
            <CardOffer lienTo ="/particulier-ouvrir-un-compte-bancaire-en-ligne" valueProfil="PARTICULIER">
            ...
            <CardOffer lienTo ="/MRE-ouvrir-un-compte-bancaire-au-maroc" valueProfil="MRE">
            ...
            <CardOffer lienTo ="/compte-bancaire-en-ligne-pour-etudiant" valueProfil="ETUDIANT">
            ...
            <CardOffer lienTo ="/professional-offres" valueProfil="PROFESSIONNEL">
